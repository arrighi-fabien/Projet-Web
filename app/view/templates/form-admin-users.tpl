<form method="post" class="admin-form card-background">
    <div class="admin-form__element">
        ...
        <input type="text" placeholder="Nom de l'utilisateur..." value="{if isset($user_card->last_name)}{$user_card->last_name}{/if}" name="last_name" id="last_name">
    </div>
    <div class="admin-form__element">
        <label for="first_name">Prénom</label>
        <input type="text" placeholder="Prénom de l'utilisateur..." value="{if isset($user_card->first_name)}{$user_card->first_name}{/if}" name="first_name" id="first_name">
    </div>
    <div class="admin-form__element">
        <label for="email">Email</label>
        <input type="email" placeholder="Email..." value="{if isset($user_card->email)}{$user_card->email}{/if}" name="email" id="email"></input>
    </div>
    <div class="admin-form__element">
        <label for="password">Mot de passe</label>
        <input type="password" placeholder="Mot de passe..." value="" name="password" id="password"></input>
    </div>
    <div class="admin-form__element">
        <select name="id_center" id="id_center">
