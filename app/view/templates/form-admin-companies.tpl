<form method="post" class="admin-form card-background">
    ...
    <div class="admin-form__element">
        ...
        <input type="email" placeholder="Email..." value="{if isset($company->email)}{$company->email}{/if}" name="email" id="email" pattern="[A-Za-zÀ-ÿ @._-]+" required></input>
    </div>
    <div class="admin-form__element">
    ...
    <div class="admin-form__element">
        ...
        <textarea name="description" placeholder="Description..." id="description" cols="30" rows="10" required>{if isset($company->company_description)}{$company->company_description}{/if}</textarea>
    </div>
